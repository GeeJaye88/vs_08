...
void AppKamera::SetDefaultRotate(FLOAT x, FLOAT y, FLOAT z)
{
	pi_app_kamera->_rotate_default.x = x;
	pi_app_kamera->_rotate_default.y = y;
	pi_app_kamera->_rotate_default.z = z;
}
...
void AppKamera::SetDefaultRotate()
{
	...
	// ---- update
		pi_app_kamera->_rotate.x = pi_app_kamera->_rotate_default.x;
		pi_app_kamera->_rotate.y = pi_app_kamera->_rotate_default.y;
		pi_app_kamera->_rotate.z = pi_app_kamera->_rotate_default.z;
...
INT AppKamera::IncRotate(Ordinate o, FLOAT delta)
{
	...
	*value = *value + pi_app_kamera->_rotate_incr * pi_app_kamera->_scalar_incr * delta;
...
void AppKamera::SetDefaultTranslate(VsVector3 *v)
{
...
void AppKamera::SetDefaultTranslate(FLOAT x, FLOAT y, FLOAT z)
{
	VsVector3 v = { x, y, z };
	SetDefaultTranslate(&v);
}
