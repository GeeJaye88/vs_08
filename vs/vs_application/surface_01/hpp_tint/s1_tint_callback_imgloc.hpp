...
// ---------- s1_tint_callback_imgloc.hpp ----------
/*!
\file s1_tint_callback_imgloc.hpp
\brief
	...
	)
{
	...
	// --- detail
		...
		// ---- row 1
			li[++i].SetAtlas(4, 5, 0);
			li[++i].SetAtlas(4, 5, 2);   li[i].SetXOff(1.1f);
			li[++i].SetAtlas(4, 5, 0);   li[i].SetXOff(2.7f);
			li[++i].SetAtlas(4, 5, 2);   li[i].SetXOff(3.8f);   li[i].SetLF(TRUE);

		// ---- row 2
			li[++i].SetAtlas(4, 5, 0);
			li[++i].SetAtlas(4, 5, 2);   li[i].SetXOff(1.1f);
			li[++i].SetAtlas(4, 5, 0);   li[i].SetXOff(2.7f);
			li[++i].SetAtlas(4, 5, 2);   li[i].SetXOff(3.8f);   li[i].SetLF(TRUE);   li[i].SetLFI(8);

		// ---- row 3
			li[++i].SetAtlas(4, 7, 0);
			li[++i].SetAtlas(4, 3, 5);   li[i].SetXOff(1.1f);   li[i].SetLF(TRUE);
			li[++i].SetAtlas(4, 7, 1);  
			li[++i].SetAtlas(4, 7, 2);   li[i].SetXOff(1.1f);
			li[++i].SetAtlas(4, 7, 3);   li[i].SetXOff(2.2f);
			li[++i].SetAtlas(4, 7, 4);   li[i].SetXOff(3.3f);   li[i].SetLF(TRUE);   li[i].SetLFI(8);

		// ---- row 4
			li[++i].SetAtlas(4, 7, 5);
			li[++i].SetAtlas(4, 7, 6);   li[i].SetXOff(1.1f);   li[i].SetLF(TRUE);   li[i].SetLFI(8);

		// ---- row 5
			li[++i].SetAtlas(4, 7, 7); 
			li[++i].SetAtlas(4, 2, 3);   li[i].SetXOff(1.5f);
			li[++i].SetAtlas(4, 2, 4);   li[i].SetXOff(2.6f);   li[i].SetLF(TRUE);   li[i].SetLFI(8);
		...
		// ---- row 6
			...
			#else
			li[++i].SetAtlas(4, 3, 5);
			li[++i].SetAtlas(4, 4, 3);   li[i].SetXOff(2.6f); li[i].SetLF(TRUE);
			#endif
			li[i].SetLFI(4);
	...
	)
{
	...
	// ---- set tint body logical id (invoked outside, e.g. model, the tint ecosystem)
		result = tint->SetSelectedBody(TINT_BODY_IMGLOC_LID);
