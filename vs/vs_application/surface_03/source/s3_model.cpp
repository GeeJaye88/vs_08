...
public:
	...
	// ---- SHARED ----
		...
		VOID set_targ(UINT loi)
		{
			surface_03->SetTargetLoiIndex(loi);
		}
...
INT Model::Display(vs_system::PanelContext *panel_gfx_context, CHAR *fred)
{
	...
	// ---- upddate profile measurements
		//if ( surface_03->GetTargetLoiMeasure() )
		//	result = Tint_Measure_UpdateElement((INT)this, 0);
		//
		// now invoked in Model::SetMsgCameraControl [ if (target__mode) { ... } ]
