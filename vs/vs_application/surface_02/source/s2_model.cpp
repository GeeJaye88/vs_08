...
public:
	...
	// ---- objects managed by model
		model::Surface_02 *surface_02 = NULL;
...
INT Model::Display(vs_system::PanelContext *panel_gfx_context, CHAR *fred)
{
	...
	// ---- dx fonts
			...
			result = pi_model->surface_02->Display3DText(pi_model->app_kamera[0]);
		#endif
...
// ---- stuff
#include "../hpp/s2_model_kamera.hpp"
#include "../hpp/s2_model_acquire.hpp"


// ---- panels layout methods
#include "../../surface_shared/hpp/model_panel_get_display_list_handle.hpp"
#include "../hpp/s2_model_panels_set_layout.hpp"


// ---- parameter methods
#include "../hpp_param/s2_model_param_interface.hpp"


// ---- project methods
#include "../hpp/s2_model_project_framework.hpp"
...
#include "../hpp_tint/s2_tint_callback.hpp"
#include "../hpp_tint/s2_tint_get.hpp"
#include "../hpp_tint/s2_tint_select.hpp"
#include "../hpp_tint/s2_tint_setup.hpp"
...
// ---- keypad -> surface tint
#include "../hpp_param/s2_model_kpad_set_with_tint_update.hpp"
