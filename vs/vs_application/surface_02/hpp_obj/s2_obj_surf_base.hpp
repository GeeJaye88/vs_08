...
// ---------- s2_obj_surf_base.hpp ----------
/*!
\file s2_obj_surf_base.h
\brief 
...
*/
INT Surface_02::ObjectSurfBase_Setup(INT index, Surface_02 *p_s_02)
{
	...
	// ---- create quad ?
		if ( pimp->runtime )
		{
			pimp->gfx_elem_handle[PI_Surface_02::ELM_SURF_BASE_LIST_IDX][0] = gfx->AddElement(
		...
		else
		{
			pimp->gfx->SetElementConfigureBitmask(
					pimp->gfx_elem_handle[PI_Surface_02::ELM_SURF_BASE_LIST_IDX][0],
...
\return INT - ERROR <=0 < VS_OK
*/
INT Surface_02::ObjectSurfBase_Display(INT index, Surface_02 *p_s_02, BOOL visible)
{
