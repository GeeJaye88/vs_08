	...
	)
{
	...
	// ---- setup kamera - especially for measure
	...
	)
{
	...
	// ---- set body param group
		switch ( body_id )
		{
			...
			// ---- store kamera & target status stuff
				case TINT_BODY_MEASURE_STORE_KAMERA:
					{
						// ---- kamera
			...
			// ---- and continue to .... set measure stuff
				case TINT_BODY_MEASURE_LID:
					{
			...
			// ---- restore kamera and target status stuff 
				default:
					{
						// ---- kamera
