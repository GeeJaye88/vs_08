...
// ---------- s3_obj_surf_edge.hpp ----------
/*!
\file s3_obj_surf_edge.h
\brief 
...
*/
INT Surface_03::ObjectSurfEdge_Setup(INT index, Surface_03 *p_s_03)
{
	...
	// ---- add element ----
		if ( pimp->runtime )
		{
			pimp->gfx_elem_handle[PI_Surface_03::ELM_SURF_EDGE_LIST_IDX][0] =
				pimp->gfx->AddElement(
	...
	// ---- setup/update common parameters
		INT result = ObjectSurfEdge_UpdateParam(index, p_s_03);
...
\return INT - ERROR <=0 < VS_OK
*/
INT Surface_03::ObjectSurfEdge_Display(INT index, Surface_03 *p_s_03, BOOL visible)
{
...
*/
INT Surface_03::ObjectSurfEdge_Update(INT index, Surface_03 *p_s_03)
{
...
\return INT - ERROR <=0 < VS_OK
*/
INT Surface_03::ObjectSurfEdge_UpdateParam(INT index, Surface_03 *p_s_03)
{
	...
	// ---- parameters
		...
		param[vs_system::ObjConfig::MESH_TYPE]   = (FLOAT)(pimp->_configuration.mesh.solid ? 1 : 0);
