				...
				case '0':
					{
						...
						pi_model->surface_03->SetTargetLoiIndex(tid);
					}
					break;
				...
				case 'G':
					{
						...
						pi_model->surface_03->SetTargetLoiIndex(CameraTarget::NONE);
										...
										case AppKamera::Mode::TARGET :
											{
												...
												// ----target  mode ?
													...
													if ( target_transform )
													{
														BOOL high_speed = kamera->GetScalarSpeed();
														if ( high_speed )
														{
															t_delta = delta / 200;
															r_delta = delta / 80;
												...
												// ---- kamera
													switch ( message )
													{
														case 'R':
															{
																if ( target_transform )
																	surface_03->SetTargetLoiIncr(0, r_delta, 0, persistant);
																else
														...
														case 'A':
															{
																if (target_transform)
																{
																	BOOL flip_dir = surface_03->SetTargetLoiIncr(-t_delta, 0, 0, persistant);
																	if ( flip_dir )
																	{
																		message = 'D';
														...
														case 'W':
															{
																if ( target_transform )
																{
																	BOOL flip_dir = surface_03->SetTargetLoiIncr(0, 0, t_delta, persistant);
																	if ( flip_dir )
																	{
																		message = 'S';
																		INT result = Tint_Explore_UpdateControlByMsg((INT)this, message);
													...
													{
														// ---- update loi
															surface_03->ObjectLoiSpot_Update(surface_03);
															surface_03->ObjectLoiRect_Update(surface_03);
															surface_03->ObjectLoiRule_Update(surface_03);
															surface_03->ObjectLoiSect_Update(surface_03);
															surface_03->ObjectLoiAxis_Update(surface_03);
													}
