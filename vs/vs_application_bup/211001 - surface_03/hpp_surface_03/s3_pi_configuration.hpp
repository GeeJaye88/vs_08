...
// -------- TARGET ------------------------------------------------
	...
	// ---- measure fov
		VOID Surface_03::SetTargetLoiMeasureFov(FLOAT target_fov)
		{
			pi_surface_03->_configuration.target_fov = target_fov;
		}
		FLOAT Surface_03::GetTargetLoiMeasureFov()
		{
			return pi_surface_03->_configuration.target_fov;
		}


	// ---- status
		VOID Surface_03::SetTargetLoiStatus(BOOL target_status)
		{
			pi_surface_03->_configuration.target_status = target_status;
		}
		BOOL Surface_03::GetTargetLoiStatus()
		{
			return pi_surface_03->_configuration.target_status;
		}
			...
			)
		{
			...
			// ---- sample
				for (sample=0; sample<num_samples; sample++)
				{
					...
					// ---- minimax
						y = *(array + sample_offset) * GetTargetLoiHeightScalar();
