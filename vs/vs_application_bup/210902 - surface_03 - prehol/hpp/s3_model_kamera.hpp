										...
										case AppKamera::Mode::TARGET :
											{
												...
												// ----target  mode ?
													model::Surface_03 *surface_03 = s_pi_model->surface_03;
													BOOL target_transform = surface_03->GetTargetLoiTranslate();
												...
												// ---- kamera
													switch (message)
													{
														case 'R':
															{
																if ( target_transform )
																	surface_03->SetTargetLoiIncr(0, r_delta, 0);
																else
														...
														case 'A':
															{
																if ( target_transform )
																	surface_03->SetTargetLoiIncr(-t_delta, 0, 0);
																else
														...
														case 'W':
															{
																if ( target_transform )
																	surface_03->SetTargetLoiIncr(0, 0, t_delta);
																else
