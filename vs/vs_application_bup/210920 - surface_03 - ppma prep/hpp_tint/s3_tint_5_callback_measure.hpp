	...
	)
{
	...
	// ---- local
		...
		OutputDebugString("Tint_Measure_UpdateModel\n");
	...
	)
{
	...
	// ---- set tint body logical id (invoked outside, e.g. model, the tint ecosystem)
		...
		OutputDebugString("Tint_Measure_UpdateElement\n");
...
{ 
	...
	OutputDebugString("Tint_Measure_AddAction\n");
	return 0;
}
	...
	)
{
	...
	*text = NULL;
	...
	OutputDebugString("Tint_Measure_AddText\n");
	return VS_OK;
}
	...
	)
{
	...
	*value     = 0;
	...
	OutputDebugString("Tint_Measure_AddValue\n");
	return VS_OK;
}
