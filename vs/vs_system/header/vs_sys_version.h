...
#define VS_SYS_VERSION_MAJOR 7 // 2020/2/16
#define VS_SYS_VERSION_MINOR 1 // 2020/2/16
#define VS_SYS_VERSION_PATCH 1 // 2020/2/16


// Note: see "FILEVERSION [#,#,#,#]" and VALUE "FileVersion", "[#,#,#,#]", e.g. "4,1,1,1441"
#define VS_SYS_VERSION_BUILD 2042 // 2020/2/16
...
// Note: see VALUE "LegalCopyright",  "[Copyright © #]", e.g. "2013 - 2019"
#define VS_SYS_COPYRIGHT_YEAR "2013 - 2020"
