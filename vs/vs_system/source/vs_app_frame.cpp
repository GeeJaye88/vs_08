	...
	)
{
	...
	// ---- panels
		...
		while ( panel )
		{
			...
			// ---- context
				PanelContext *panel_context = master_panel->GetPanelContext();
			...
			// ---- for each display list
					...
					)
				{
						...
						result = panel_context->GetDisplayListHandle(
								display_list_index,
								&display_list_handle
							);

						pi_app_frame->gfx_interface->SetElementStatus(
								display_list_handle,
								group_id,
								element_id,
								op_id,
