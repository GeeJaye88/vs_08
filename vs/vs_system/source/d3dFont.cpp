//////////////////////////////////////////////////////////////////////////////////////////////////
//
// d3dFont.cpp: implementation of the directx tainted CD3DFont - a texture-based font class
//
//////////////////////////////////////////////////////////////////////////////////////////////////
...
struct  FONT3DVERTEX { D3DXVECTOR3 p;   D3DXVECTOR3 n;   DWORD c;  FLOAT tu, tv; };
...
inline  FONT3DVERTEX InitFont3DVertex( const D3DXVECTOR3& p, const D3DXVECTOR3& n,
										DWORD c, FLOAT tu, FLOAT tv )
{
	FONT3DVERTEX v;   v.p = p;   v.n = n;   v.c = c;   v.tu = tu;   v.tv = tv;
    return v;
}
...
HRESULT CD3DFont::InitDeviceObjects( LPDIRECT3DDEVICE9 pd3dDevice )
{
	...
	if (m_dwFontHeight > 40)
		m_dwTexWidth = m_dwTexHeight = 2048; //1024;
	else if (m_dwFontHeight > 20)
		m_dwTexWidth = m_dwTexHeight = 1024; //512;
	else
		m_dwTexWidth = m_dwTexHeight = 512; //256;
...
HRESULT CD3DFont::Render3DText( const TCHAR* strText, DWORD dwColor, DWORD dwFlags )
{
    ...
    while( (c = *strText++) != 0 )
    {
        ...
        if( c != _T(' ') )
        {
            *pVertices++ = InitFont3DVertex( D3DXVECTOR3(x+0,y+0,0), D3DXVECTOR3(0,0,-1), dwColor, tx1, ty2 );
            *pVertices++ = InitFont3DVertex( D3DXVECTOR3(x+0,y+h,0), D3DXVECTOR3(0,0,-1), dwColor, tx1, ty1 );
            *pVertices++ = InitFont3DVertex( D3DXVECTOR3(x+w,y+0,0), D3DXVECTOR3(0,0,-1), dwColor, tx2, ty2 );
            *pVertices++ = InitFont3DVertex( D3DXVECTOR3(x+w,y+h,0), D3DXVECTOR3(0,0,-1), dwColor, tx2, ty1 );
            *pVertices++ = InitFont3DVertex( D3DXVECTOR3(x+w,y+0,0), D3DXVECTOR3(0,0,-1), dwColor, tx2, ty2 );
            *pVertices++ = InitFont3DVertex( D3DXVECTOR3(x+0,y+h,0), D3DXVECTOR3(0,0,-1), dwColor, tx1, ty1 );
            dwNumTriangles += 2;
