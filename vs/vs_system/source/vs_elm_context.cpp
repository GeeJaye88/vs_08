...
class ElmContext::PI_ElmContext
{
	...
	// ---- ctor
		PI_ElmContext()
		{
			...
			// ---- indices
				material_index    = 0;
				shader_index      = 0;
				view_matrix_index = VIEW_MATRIX_INDEX_DEFAULT;
	...
	// ---- status
		...
		UINT   blink_frame;        // blink_max
		UINT   blink_max;          // e.g. 30
	...
	// ---- render flags
		...
		BOOL   alpha_texture;                 // requires alpha blending, diffuse component & texture
		BOOL   ambient;                       // ambient or not
		BOOL   colour_vertex;                 // wifreframe - requires diffuse component 
		BOOL   fog;                           // fog or not
		BOOL   lit;                           // lit or not
...
// ---------- SetBlinkEnd ----------
INT ElmContext::SetBlinkEnd()
{
	pi_elm_context->blink_max = pi_elm_context->blink_max;
	return VS_OK;
}


// ---------- SetBlinkFrame ----------
INT ElmContext::SetBlinkFrame(UINT blink_frame)
{
	pi_elm_context->blink_frame = blink_frame;
	return VS_OK;
}


// ---------- SetBlinkMax ----------
INT ElmContext::SetBlinkMax(UINT blink_max)
{
	pi_elm_context->blink_max = blink_max;
	return VS_OK;
}
...
// ---------- SetAlphaTexture ----------
INT ElmContext::SetAlphaTexture(BOOL at)
{
	pi_elm_context->alpha_texture= at;
	return VS_OK;
}

// ---------- SetAmbient ----------
INT ElmContext::SetAmbient(BOOL am)
{
	pi_elm_context->ambient = am;
	return VS_OK;
}
...
// ---------- GetBlink ----------
UINT ElmContext::GetBlinkFrame()
{

	return pi_elm_context->blink_frame;
}


// ---------- GetBlinkMax ----------
UINT ElmContext::GetBlinkMax()
{
	return pi_elm_context->blink_max;
}
...
// ---------- SetAlphaTexture ----------
BOOL ElmContext::GetAlphaTexture()
{
	return pi_elm_context->alpha_texture;
}


// ---------- GetAmbient ----------
BOOL ElmContext::GetAmbient()
{
	return pi_elm_context->ambient;
}
