...
public:
	...
	AppDependency *app_dependency = NULL;
	AppFrame      *selected_frame = NULL;
	AppFrame      *first_frame    = NULL;
	AppFrame      *last_frame     = NULL;
...
\return INT - ERROR <= 0 < VS_OK
*/
INT AppView::GetPanelStatus(CHAR *name, PanelPropertyLid lid, BOOL *value)
{
					...
					// ---- name matched ?
						...
						if ( panel_name != NULL )
						{
							if (!strcmp(name, panel_name))
							{
								switch (lid)
								{
									case BACKGROUND  : *value = panel_context->GetBackground();    break;
									case BORDER      : *value = panel_context->GetBorder();        break;
									case DISPLAY     : panel_context->GetDisplayStatus(value);     break;
									case INTERACTION : panel_context->GetSelected(value);          break;
									case SELECTED    : panel_context->GetInteractionStatus(value); break;
									default:
										return VS_ERROR;
										break;
								}
...
// ---------- SetPanelStatus ----------
/*!
\brief Set panel status
\author Gareth Edwards
\return INT - ERROR <= 0 < VS_OK
*/
INT AppView::SetPanelStatus(CHAR *name, PanelPropertyLid lid, BOOL value)
{
					...
					// ---- name matched ?
						...
						if ( panel_name != NULL )
						{
							if (!strcmp(name, panel_name))
							{
								switch (lid)
								{
									case BACKGROUND  : panel_context->SetBackground(value);        break;
									case BORDER      : panel_context->SetBorder(value);            break;
									case DISPLAY     : panel_context->SetDisplayStatus(value);     break;
									case INTERACTION : panel_context->SetSelected(value);          break;
									case SELECTED    : panel_context->SetInteractionStatus(value); break;
									default:
										return VS_ERROR;
										break;
								}
...
// ---------- GetPanelDisplayStatus ----------
/*!
\brief Get panel display status
\author Gareth Edwards
\return INT - ERROR <= 0 < VS_OK
*/
INT AppView::GetPanelDisplayStatus(CHAR *name, BOOL *status)
{
...
/*!
\brief Set panel display status
\author Gareth Edwards
\return INT - ERROR <= 0 < VS_OK
*/
INT AppView::SetPanelDisplayStatus(CHAR *name, BOOL status)
{
...
/*!
\brief Get panel interaction status
\author Gareth Edwards
\return INT - ERROR <= 0 < VS_OK
*/
INT AppView::GetPanelInteractionStatus(CHAR *name, BOOL *status)
{
...
// ---------- SetPanelDisplayListHandle ----------
/*!
\brief Set panel handle for a display list "name" 
\author Gareth Edwards
\return INT - ERROR <= 0 < VS_OK
...
\note invoked from 
*/
INT AppView::SetPanelDisplayListHandle(CHAR *name, INT handle)
{
...
// ---------- SetPanelInteractionStatus ----------
/*!
\brief Set panel interaction status
\author Gareth Edwards
\return INT - ERROR <= 0 < VS_OK
*/
INT AppView::SetPanelInteractionStatus(CHAR *name, BOOL status)
{
...
// ---------- SetPanelPane ----------
/*!
\brief Setup a panel pane 
\author Gareth Edwards
\param UINT - number of AppPane's
\param AppPanes* - array of AppPane's
*/
INT AppView::SetPanelPane(
		UINT number_panes,
		AppPane *panes
	)
{
...
// ---------- SetElementStatus ----------
/*!
\brief Set element status
\author Gareth Edwards
\return INT - ERROR <= 0 < VS_OK
*/
INT AppView::SetElementStatus(
		INT group_id,
		INT element_id,
		INT op_id,
		BOOL value
	)
{
	...
	// ---- frames
		...
		while ( frame )
		{
			frame->SetElementStatus(group_id, element_id, op_id, value);
			frame = frame->GetNext();
		}
