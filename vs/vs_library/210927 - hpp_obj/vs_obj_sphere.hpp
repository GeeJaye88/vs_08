...
// ---------- Callback_Sphere_Configure ----------
INT ObjConfig::Callback_Sphere_Configure(vs_system::ElmContext *context)
{
	...
	// ---- index buffer
		...
		context->SetIndexBufferCallback(&Callback_Sphere_GetIndexBuffer);
	...
	// ---- vertex buffer
		...
		context->SetVertexBufferCallback(&Callback_Sphere_GetVertexBuffer);
...
// ----------  Callback_Sphere_GetVertexBuffer ----------
/*!

*/
INT ObjConfig::Callback_Sphere_GetVertexBuffer(vs_system::ElmContext *context)
{
	...
	// ---- parameters
		...
		UINT  sphere_ap_ref   = 0; // not used
		UINT  sphere_ap_sect  = 0; // not used
...
// ---------- Callback_Sphere_GetIndexBuffer ----------
INT ObjConfig::Callback_Sphere_GetIndexBuffer(vs_system::ElmContext *context)
{
