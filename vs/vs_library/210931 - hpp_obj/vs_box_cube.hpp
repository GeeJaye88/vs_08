...
// ---------- Callback_Box_Configure ----------
INT ObjConfig::Callback_Box_Configure(vs_system::ElmContext *context)
{
...
// ---------- Callback_Box_GetVertexBuffer ----------
INT ObjConfig::Callback_Box_GetVertexBuffer(vs_system::ElmContext *context)
{
...
// ---------- Callback_Box_GetVertexBuffer ----------
INT ObjConfig::Callback_Box_GetVertexBufferB(vs_system::ElmContext *context)
{
